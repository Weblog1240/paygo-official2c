      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="border-l-4 border-red-400 p-4 mb-4 bg-green-50">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <h4 className="font-bold text-red-600">Opay Bank Service is Currently down</h4>
          </div>
          <p className="text-sm text-red-600">All Other banks transfers are working perfectly. You can proceed with your payment safely.</p>
        </div>
        
        <p className="text-gray-600 text-sm mb-6">We appreciate your patience. All banks except Opay bank you can use any other bank to your payment will be processed immediately.</p>
        ...
        return <div className="min-h-screen bg-gray-50">
            <div className="p-6 space-y-6">
              <div className="text-center bg-amber-400">
                ...
                <p className="text-gray-600 text-sm">Transfer ₦7,200 to the account below</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  ...
                  <div className="flex items-center space-x-3">
                    <span className="text-xl font-bold text-gray-900">8109117136</span>
                    <Button onClick={() => handleCopy('8109117136')} className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 text-sm rounded-md">
                      Copy
                    </Button>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  ...
                  <span className="text-xl font-bold text-gray-900">NANVANG ISAIAH</span>
                </div>
              </div>
